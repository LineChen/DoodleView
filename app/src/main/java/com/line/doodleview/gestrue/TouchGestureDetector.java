...
package com.line.doodleview.gestrue;
...
public class TouchGestureDetector {
    ...
    private final TouchGestureDetector.IOnTouchGestureListener mOnTouchGestureListener;
    private boolean mIsScrollAfterScaled = true;

    public TouchGestureDetector(Context context, TouchGestureDetector.IOnTouchGestureListener listener) {
        this.mOnTouchGestureListener = new TouchGestureDetector.OnTouchGestureListenerProxy(listener);
    ...
    public interface IOnTouchGestureListener extends OnGestureListener, OnDoubleTapListener, ScaleGestureDetectorApi27.OnScaleGestureListener {
    ...
    private class OnTouchGestureListenerProxy implements TouchGestureDetector.IOnTouchGestureListener {
        private TouchGestureDetector.IOnTouchGestureListener mListener;
        private boolean mHasScaled = false;
        private boolean mIsScrolling = false;
        private MotionEvent mLastScrollMotionEvent;

        public OnTouchGestureListenerProxy(TouchGestureDetector.IOnTouchGestureListener listener) {
