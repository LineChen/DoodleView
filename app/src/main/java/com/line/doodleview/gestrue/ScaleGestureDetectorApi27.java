...
public class ScaleGestureDetectorApi27 {
    ...
    public ScaleGestureDetectorApi27(Context context, ScaleGestureDetectorApi27.OnScaleGestureListener listener, Handler handler) {
        this.mAnchoredScaleMode = 0;
        this.mContext = context;
        this.mListener = listener;
        this.mSpanSlop = ViewConfiguration.get(context).getScaledTouchSlop() * 2;
        Resources res = context.getResources();
        this.mMinSpan = res.getDimensionPixelSize(R.dimen.androids_api27_config_minScalingSpan);
